      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0">
            <span className="uppercase text-2xl font-bold">The-Sharad</span>
          </div>
          ...
          <div className="flex space-x-6 mb-6 md:mb-0">
            ...
            <a
              href="https://github.com/SharadBhardwaj31"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/sharad-bhardwaj-471785278 "
              target="_blank"
              rel="noopener noreferrer"
              className="text-teal-800 hover:text-teal-900 transition"
            >
            ...
            <a
              href="https://instagram.com/_bhardwaj_sharad_"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="text-zinc-900 text-sm">
            © 2026 The-Sharad Developer, All rights reserved.
          </div>
        </div>
      </div>
    </div>
